// prototype_v3/src/app/swap/SwapResultModal.tsx
...
const SwapResultModal = ({
  ...
  const [href, setHref] = useState('https://etherscan.io/tx/')
      ...
      >
        ...
        {txHash !== '' && (
          <div className="h-[60%] flex flex-col justify-center items-center">
            ...
            <div
              className={
                isLight ? styles.lightHeadingsMain : styles.darkHeadingsMain
              }
            >
        ...
        {errorMessage !== '' && (
          <div className="h-[60%] flex justify-center items-center">
            <div
              className={
                isLight ? styles.lightHeadingsError : styles.darkHeadingsError
              }
            >
              {errorMessage}
            </div>
...
const styles = {
  ...
  lightButton:
    'w-[90%] h-[80%] bg-orange-400 text-center rounded-xl text-white',
